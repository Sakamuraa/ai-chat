...
const id: Dict = {
  ...
  "account.switchEmpty": "Belum ada akun lain di perangkat ini.",
  "auth.cancelSwitch": "Batal, kembali ke akun sebelumnya",
...
const en: Dict = {
  ...
  "account.back": "Back",
  "account.switchEmpty": "No other account on this device.",
  "auth.cancelSwitch": "Cancel, back to previous account",
